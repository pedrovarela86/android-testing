    ...
    companion object {
        ...
        fun getRepository(app: Application): DefaultTasksRepository {
            return INSTANCE ?: synchronized(this) {
                ...
                val database = Room
                        .databaseBuilder(app.applicationContext, ToDoDatabase::class.java, "Tasks.db")
                        .build()

                DefaultTasksRepository(TasksRemoteDataSource, TasksLocalDataSource(database.taskDao()), Dispatchers.IO).also {
                    INSTANCE = it
                }
            }
        }
